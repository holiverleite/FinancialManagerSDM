...
public class TransactionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner config
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(this,R.layout.spinner_item,accountsName);
        ...
        switch (v.getId()) {
            ...
            case R.id.saveButton:
                ...
                if (amountValue.matches("") || description.matches("") || optionIsCredit == null) {
                    ...
                    resultIntent.setAction(ListaContasActivity.EXTRA_TRANSACTION);
