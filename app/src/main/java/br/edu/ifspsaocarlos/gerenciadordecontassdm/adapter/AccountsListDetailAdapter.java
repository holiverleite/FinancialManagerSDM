...
public class AccountsListDetailAdapter extends ArrayAdapter<Transaction> {
    private LayoutInflater layoutInflater;

    public AccountsListDetailAdapter(Context context, List<Transaction> accountDetailList) {
        super(context, R.layout.layout_view_account_adapter, accountDetailList);
